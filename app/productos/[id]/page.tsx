      ...
      <main className="min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-gray-900 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">(24 reseñas)</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Productos de alta calidad garantizados</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Tabs defaultValue="description" className="mb-12">
            ...
            <TabsContent value="description" className="bg-white dark:bg-gray-800 p-6 rounded-lg mt-6">
            ...
            <TabsContent value="specifications" className="bg-white dark:bg-gray-800 p-6 rounded-lg mt-6">
            ...
            <TabsContent value="reviews" className="bg-white dark:bg-gray-800 p-6 rounded-lg mt-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">
                    Muy satisfecho con la calidad del producto. Llegó en perfectas condiciones y cumple con todas mis
                    expectativas.
                  </p>
                  <div className="text-xs text-gray-500">
                    <span className="font-medium">María G.</span> - 15 de abril, 2023
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                    <span className="font-medium">Carlos P.</span> - 2 de marzo, 2023
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                    <span className="font-medium">Ana R.</span> - 18 de febrero, 2023
                  </div>
                </div>
              </div>
            </TabsContent>
              ...
              {relatedProducts.map((relatedProduct) => (
                <Card key={relatedProduct.id} className="overflow-hidden group">
                  ...
                  <CardContent className="p-4">
                    <Link href={`/productos/${relatedProduct.id}`} className="block mb-2">
                    ...
                    <div className="flex items-center justify-between mt-2">
                        ...
                        {relatedProduct.discount > 0 ? (
                          <>
                            <span className="font-bold text-red-600">
                              {formatCurrency(relatedProduct.price * (1 - relatedProduct.discount / 100))}
                            </span>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          toast({
                            title: "Producto añadido",
                            description: `${relatedProduct.name} ha sido añadido a tu carrito.`,
                          })
                        }}
                      >
